"""
Main entry point for running the QuadPole simulation using PPO with a Neural Network Policy.
"""

if __name__ == "__main__":
    # Import the pipeline creation function for the Cartpole simulation.
    from pipelines import create_quadpole_pipeline_ppo

    # Create the cartpole pipeline with specified test parameters.
    pipeline = create_quadpole_pipeline_ppo(
        test_name="quadpole_nn_ppo",      # Identifier for this test instance.
        ...
        # load_path='archive/QuadPole/quadpole_nn_ppo/001'
    )
