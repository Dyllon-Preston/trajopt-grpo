import torch
from environments import QuadPole2D
...
def create_quadpole2d_env() -> QuadPole2D:
    """
    Instantiate the QuadPole2D environment.

    Returns:
        QuadPole2D: A new QuadPole2D environment instance.
    """
    return QuadPole2D()

def create_quadpole2d_pipeline_ppo(
    test_name: str,
    checkpoint_name: str,
    env_fn: Optional[Callable[[], QuadPole2D]] = None,
    ...
    """
    env_fn = env_fn or create_quadpole2d_env
