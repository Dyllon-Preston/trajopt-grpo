import torch
from environments import QuadPole
...
def create_quadpole_env() -> QuadPole:
    """
    Instantiate the QuadPole environment.

    Returns:
        CartPole: A new QuadPole environment instance.
    """
    return QuadPole()

def create_quadpole_pipeline_ppo(
    test_name: str,
    checkpoint_name: str,
    env_fn: Optional[Callable[[], QuadPole]] = None,
    ...
    """
    Constructs a pipeline for executing a QuadPole experiment.
    ...
    """
    env_fn = env_fn or create_quadpole_env
